...
void VsimTop::_ctor_var_reset() {
    ...
    simTop__DOT__mycore__DOT__cpath__DOT___T_469 = VL_RAND_RESET_I(2);
    ...
    simTop__DOT__mycore__DOT__dpath__DOT__exe_reg_ctrl_mem_typ = VL_RAND_RESET_I(3);
    ...
    simTop__DOT__mycore__DOT__dpath__DOT___T_81 = VL_RAND_RESET_I(1);
