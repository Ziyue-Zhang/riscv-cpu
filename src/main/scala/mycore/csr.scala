...
class CSRfile extends Module
{
    ...
    val exception_in_csr = read_illegal || write_illgal // illegal inst detected in csr file
    ...
    when(reg_mip.mtip && reg_mie.mtip && reg_mstatus.mie && !io.hasStall && io.in_mem_pc =/= 0.U)
    {
